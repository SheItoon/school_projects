...
BonusSpeed::BonusSpeed(sw::Entity& entity) :
sw::Script(entity),
m_animTime(0.0f)
{}

BonusSpeed::~BonusSpeed() noexcept
{
    m_entity.m_scene.deleteEntity(m_entity.m_name);
}

void BonusSpeed::start()
{
    auto& transform = m_entity.createComponent<ray::Transform>("TransformFact");

    transform.setScale(0.5f, 0.5f, 0.5f);
    m_entity.createComponent<ray::Mesh>("MeshFact").setModel("BonusSpeed").setTexture("SpeedIcon");
...
void BonusSpeed::onCollision(sw::Entity& entity)
{
    takeIt(entity);
}

void BonusSpeed::takeIt(sw::Entity& entity)
{
